...
const Header = (props) => {
	...
	return (
		<div className="max-w-[90rem] mx-auto mt-20 py-5">
			...
			<p className="w-3/5 mx-auto leading-relaxed mt-6">
				<h4 className="font-medium text-xl my-2"> 2. Implementation of the adjusted IVMs (<a href="https://github.com/hj-n/btw-dataset-internal-measures" className="text-sky-600 hover:underline">Link</a>)</h4>
